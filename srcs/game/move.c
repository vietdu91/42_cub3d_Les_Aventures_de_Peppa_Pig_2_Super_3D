...
/*   Updated: 2022/07/04 20:43:03 by emtran           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	a_key(t_data *data)
{
	...
	x1 = (data->game->p1->pos_x + data->game->p1->dir_x * data->game->p1->move_speed) + check_nope_wall(data->game->p1, 'x');
	y1 = (data->game->p1->pos_y) + check_nope_wall(data->game->p1, 'y');
	x2 = (data->game->p1->pos_x) + check_nope_wall(data->game->p1, 'x');
	y2 = (data->game->p1->pos_y + data->game->p1->dir_y * data->game->p1->move_speed) + check_nope_wall(data->game->p1, 'y');
