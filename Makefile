...
$(NAME):	${OBJS} ${INCLUDES}
			...
			@printf "$(ROUGE)                   $(RESET)$(NOIR)  $(RESET)$(ROSE)         $(RESET)$(NOIR)        $(RESET)$(BLANC)  $(RESET)$(NOIR)      $(RESET)$(ROSE)    $(RESET)$(NOIR)    $(RESET)$(ROSE)  $(RESET)$(NOIR)  $(RESET)\n"
			@printf "$(ROUGE)                   $(RESET)$(NOIR)  $(RESET)$(ROSE)       $(RESET)$(NOIR)          $(RESET)$(BLANC)  $(RESET)$(NOIR)    $(RESET)$(BLANC)  $(RESET)$(NOIR)  $(RESET)$(ROSE)  $(RESET)$(NOIR)  $(RESET)$(ROSE)    $(RESET)$(NOIR)  $(RESET)\n"
			@printf "$(ROUGE)                   $(RESET)$(NOIR)  $(RESET)$(ROSE)           $(RESET)$(BLANC)  $(RESET)$(NOIR)    $(RESET)$(ROUGE)  $(RESET)$(NOIR)    $(RESET)$(BLANC)  $(RESET)$(NOIR)    $(RESET)$(ROSE)      $(RESET)$(NOIR)  $(RESET)\n"
			@printf "$(ROUGE)                   $(RESET)$(NOIR)  $(RESET)$(ROSE)           $(RESET)$(NOIR)    $(RESET)$(ROUGE)      $(RESET)$(NOIR)  $(RESET)$(BLANC)  $(RESET)$(NOIR)    $(RESET)$(ROSE)      $(RESET)$(NOIR)  $(RESET)\n"
			@printf "$(ROUGE)                   $(RESET)$(NOIR)  $(RESET)$(ROSE)           $(RESET)$(BLANC)  $(RESET)$(NOIR)    $(RESET)$(ROUGE)  $(RESET)$(NOIR)    $(RESET)$(BLANC)  $(RESET)$(NOIR)  $(RESET)$(ROSE)        $(RESET)$(NOIR)  $(RESET)\n"
			@printf "$(ROUGE)                   $(RESET)$(NOIR)  $(RESET)$(ROSE)       $(RESET)$(NOIR)          $(RESET)$(BLANC)  $(RESET)$(NOIR)    $(RESET)$(NOIR)  $(RESET)$(ROSE)          $(RESET)$(NOIR)  $(RESET)\n"
			@printf "$(ROUGE)                   $(RESET)$(NOIR)  $(RESET)$(ROSE)           $(RESET)$(BLANC)              $(RESET)$(ROSE)          $(RESET)$(NOIR)  $(RESET)\n"
			@printf "$(ROUGE)                   $(RESET)$(NOIR)  $(RESET)$(ROSE)           $(RESET)$(BLANC)              $(RESET)$(ROSE)          $(RESET)$(NOIR)  $(RESET)\n"
			@printf "$(ROUGE)                   $(RESET)$(NOIR)  $(RESET)$(ROSE)           $(RESET)$(BLANC)              $(RESET)$(ROSE)          $(RESET)$(NOIR)  $(RESET)\n"
			@printf "$(ROUGE)                   $(RESET)$(NOIR)  $(RESET)$(ROSE)           $(RESET)$(BLANC)            $(RESET)$(NOIR)  $(RESET)$(ROSE)          $(RESET)$(NOIR)  $(RESET)\n"
			@printf "$(ROUGE)                   $(RESET)$(NOIR)  $(RESET)$(ROSE)           $(RESET)$(BLANC)    $(RESET)$(NOIR)  $(RESET)$(BLANC)  $(RESET)$(NOIR)    $(RESET)$(JAUNE)  $(RESET)$(NOIR)  $(RESET)$(ROSE)        $(RESET)$(NOIR)  $(RESET)\n"
			@printf "$(ROUGE)                   $(RESET)$(NOIR)  $(RESET)$(ROSE)           $(RESET)$(BLANC)  $(RESET)$(NOIR)  $(RESET)$(JAUNE)  $(RESET)$(NOIR)  $(RESET)$(JAUNE)    $(RESET)$(NOIR)    $(RESET)$(ROSE)      $(RESET)$(NOIR)    $(RESET)\n"
			@printf "$(ROUGE)                   $(RESET)$(NOIR)  $(RESET)$(ROSE)           $(RESET)$(NOIR)  $(RESET)$(JAUNE)  $(RESET)$(NOIR)  $(RESET)$(JAUNE)  $(RESET)$(NOIR)  $(RESET)$(JAUNE)    $(RESET)$(NOIR)  $(RESET)$(ROSE)    $(RESET)$(NOIR)  $(RESET)$(BLANC)  $(RESET)$(NOIR)  $(RESET)\n"
			@printf "$(ROUGE)                   $(RESET)$(NOIR)  $(RESET)$(ROSE)         $(RESET)$(NOIR)  $(RESET)$(JAUNE)  $(RESET)$(NOIR)      $(RESET)$(BLANC)  $(RESET)$(NOIR)    $(RESET)$(ROSE)      $(RESET)$(NOIR)  $(RESET)$(BLANC)  $(RESET)$(NOIR)  $(RESET)\n"
			@printf "$(ROUGE)                   $(RESET)$(NOIR)  $(RESET)$(ROSE)         $(RESET)$(NOIR)    $(RESET)$(BLANC)            $(RESET)$(ROSE)    $(RESET)$(NOIR)  $(RESET)$(BLANC)  $(RESET)$(ROSE)  $(RESET)$(NOIR)  $(RESET)\n"
			@printf "$(ROUGE)                   $(RESET)$(NOIR)  $(RESET)$(ROSE)           $(RESET)$(BLANC)              $(RESET)$(ROSE)  $(RESET)$(NOIR)  $(RESET)$(BLANC)  $(RESET)$(ROSE)  $(RESET)$(ROUGE)  $(RESET)$(NOIR)  $(RESET)\n"
			@printf "$(ROUGE)                   $(RESET)$(NOIR)  $(RESET)$(ROSE)           $(RESET)$(BLANC)  $(RESET)$(NOIR)        $(RESET)$(BLANC)    $(RESET)$(NOIR)  $(RESET)$(BLANC)  $(RESET)$(ROSE)  $(RESET)$(ROUGE)    $(RESET)$(NOIR)  $(RESET)\n"
			@printf "$(ROUGE)                   $(RESET)$(NOIR)  $(RESET)$(ROSE)           $(RESET)$(BLANC)              $(RESET)$(NOIR)  $(RESET)$(BLANC)  $(RESET)$(ROSE)  $(RESET)$(ROUGE)    $(RESET)$(NOIR)  $(RESET)\n"
			@printf "$(ROUGE)                   $(RESET)$(NOIR)  $(RESET)$(ROSE)         $(RESET)$(NOIR)                $(RESET)$(ROSE)  $(RESET)$(NOIR)  $(RESET)$(ROUGE)  $(RESET)$(NOIR)  $(RESET)$(ROSE)  $(RESET)$(NOIR)  $(RESET)\n"
			@printf "$(ROUGE)                 $(RESET)$(NOIR)  $(RESET)$(ROSE)             $(RESET)$(BLANC)              $(RESET)$(ROSE)    $(RESET)$(NOIR)  $(RESET)$(ROSE)      $(RESET)$(NOIR)  $(RESET)\n"
			@printf "$(ROUGE)                 $(RESET)$(NOIR)  $(RESET)$(ROSE)             $(RESET)$(BLANC)              $(RESET)$(ROSE)            $(RESET)$(NOIR)  $(RESET)\n"
			@printf "$(ROUGE)                   $(RESET)$(NOIR)                                       $(RESET)\n"
